...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE,
    properties = "user-service.base-url:http://localhost:8090",
...
public class UserServiceContractTest {
    ...
    public RequestResponsePact pactUserExists(PactDslWithProvider builder) {
        ...
        DslPart body = LambdaDsl.newJsonBody((o) -> o
            ...
            .stringMatcher("role", "ADMIN|USER", "USER")
        ...
        return builder.given(
            "User 1 exists")
            .uponReceiving("A request to /users/10")
            .path("/users/10")
            .method("GET")
            .willRespondWith()
            .status(200)
    ...
    public void userExists() {
        final User user = userServiceClient.getUser("10");
